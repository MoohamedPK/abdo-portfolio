...
const ContactPage = () => {
    ...
    useGSAP(() => {
        const splitContactTitle = new SplitText(".contactTitle", {type: "words", mask: "words"});
        const splitContactQuote = new SplitText(".contactQuote", {type: "words", mask: "words"});
