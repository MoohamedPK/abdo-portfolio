...
const AboutPage = ({media, workMedia}: AboutPageProps) => { 
    ...
    useGSAP(() => {
        const aboutHeadTextSplit = new SplitText(".aboutHeadText", {type: "lines", mask: "lines"});
        gsap.set(aboutHeadTextSplit.lines, {opacity: 0, yPercent: 100, rotateY:40});
        ...
        <main className="">
            ...
            <section className="aboutHead h-screen relative">
                ...
                <div className=" font-mardon text-white w-full md:w-2/3 text-center text-[1.5rem] md:text-[3rem] lg:text-[3.5rem] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <p className="aboutHeadText">𓏲𝄢 STITCH MOMENTS INTO LIGHT, AND YOU WILL WEAVE MEMORIES THAT NEVER FADE 𓏲𝄢</p>
                </div>
